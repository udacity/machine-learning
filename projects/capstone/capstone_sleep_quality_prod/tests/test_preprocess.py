...
# coverage run test_preprocess.py
# coverage report –m
# coverage html

class TestPreProcess(unittest.TestCase):

    # python test_preprocess.py TestPreProcess.test__init____set_expected_properties
    ...
    # python test_preprocess.py TestPreProcess.test_extract_data__sets_expected_values
    ...
    # python test_preprocess.py TestPreProcess.test_average__returns_expected_values
    ...
    # python test_preprocess.py TestPreProcess.test_set_one_hot_encoding_list__sets_expected_values
    ...
    # python test_preprocess.py TestPreProcess.test_apply_one_hot_encoding__sets_expected_values
    ...
    # python test_preprocess.py TestPreProcess.test_set_target_column_names__sets_expected_values
    ...
    # python test_preprocess.py TestPreProcess.test_drop_columns_by_regexp__sets_expected_values
    ...
    # python test_preprocess.py TestPreProcess.test_apply_log_trans_according_to_columns_config__sets_expected_values
    ...
    # python test_preprocess.py TestPreProcess.test_apply_log_trans__sets_expected_values
    ...
    # python test_preprocess.py TestPreProcess.test_convert_values__sets_expected_values
    ...
    # python test_preprocess.py TestPreProcess.test_convert_types__sets_expected_values
    ...
    # python test_preprocess.py TestPreProcess.test_raise_values_to_positive__sets_expected_values

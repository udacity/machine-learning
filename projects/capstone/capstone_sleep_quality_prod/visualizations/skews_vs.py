...
# Converting values and types of the features
...
def make_horizontal_histogram(y_labels,values):
    ...
    ax.set_ylabel('Features')  # lbel for x axis
    ax.set_title('Absolute skew of each feature')  # specifies title

...
# pre_process_obj = pre_process.PreProcess(refined_data,columns_config)
...
parameters = {'n_estimators': [1000], 'learning_rate': [0.15,0.2,0.25,0.5]}
...
X_train_reduced = X_train[important_features[0:99].index.tolist()]
X_test_reduced = X_test[important_features[0:99].index.tolist()]
...
# print list(X_test_reduced)
sys.exit()
# print best_clf.feature_importances_
# print list(X_train)
# print len(best_clf.feature_importances_)

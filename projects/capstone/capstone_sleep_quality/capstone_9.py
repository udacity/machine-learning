...
# print pd.isnull(refined_data).sum() > 0
# sys.exit()
# refined_data = refined_data.cumsum()
# print refined_data['qs1']
# sys.exit()
# refined_data['qs1'].plot()
# plt.show()
# sys.exit()
# print refined_data['IPAQTOTAL']
# sys.exit()
...
parameters = {'n_estimators': [90,100,110,120, 130,140,150,160,170]}
...
X_train, X_test, y_train, y_test = train_test_split(features_final[important_features[0:200].index.tolist()],
                                                    sleep_quality['q30'],
                                                    test_size = test_size,
                                                    random_state=random_state)
...
X_train_reduced = X_train[important_features[0:199].index.tolist()]
X_test_reduced = X_test[important_features[0:199].index.tolist()]
